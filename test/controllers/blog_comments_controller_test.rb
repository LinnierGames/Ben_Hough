...
class BlogCommentsControllerTest < ActionController::TestCase
  ...
  test "should create blog_comment" do
    assert_difference('BlogComment.count') do
      post :create, blog_comment: { Blogs_id: @blog_comment.Blogs_id, comment: @blog_comment.comment, name: @blog_comment.name }
    end
  ...
  test "should update blog_comment" do
    patch :update, id: @blog_comment, blog_comment: { Blogs_id: @blog_comment.Blogs_id, comment: @blog_comment.comment, name: @blog_comment.name }
    assert_redirected_to blog_comment_path(assigns(:blog_comment))
  end
